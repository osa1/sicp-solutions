...
İşte hacı, bu böyle olmaz bu işte bir yanlışlık var bence. Burda integers bir pair streamı değil, `car`ı her zaman tek bir eleman ve buna `weight` fonksiyonu uygulayamıyoruz. Anlamadığım birşey var gibi ama neyse, şimdilik geçiyorum.
...
Kolay soru da kafam almıyor şuan. TODO
